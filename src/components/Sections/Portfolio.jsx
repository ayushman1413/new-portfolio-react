          ...
          >
            <div className="portfolio-image">
              ...
              <div className="portfolio-overlay">
                <button className="portfolio-btn" onClick={(e) => { e.stopPropagation(); window.open(project.url, '_blank'); }}>
